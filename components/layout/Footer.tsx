    ...
    <footer className="shrink-0 border-t-2 border-espresso bg-espresso">
      <div className="py-1.5">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-col items-start gap-1 text-left leading-tight sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-6 sm:gap-y-1 sm:leading-normal">
            <div className="flex w-full flex-col items-start gap-1 sm:w-auto sm:flex-row sm:items-center sm:gap-2">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="text-[9px] font-semibold uppercase text-cream/60 sm:text-[10px]">
                  {t("findUs")}
                </span>
                <div className="flex gap-1">
                  <a
                    ...
                    className="flex h-4 w-4 items-center justify-center rounded-full border border-cream/40 text-cream/80 hover:border-cream hover:text-cream sm:h-6 sm:w-6"
              ...
              <span className="text-[9px] text-cream/60 sm:text-[10px]">
            ...
            <div className="flex w-full flex-wrap items-center gap-x-2 gap-y-0.5 text-[9px] text-cream/70 sm:w-auto sm:text-[10px]">
          ...
          <p className="mt-0.5 text-left text-[8px] text-cream/40 sm:mt-1.5 sm:text-center sm:text-[9px]">
