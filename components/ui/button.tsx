...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-2xl font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-blue/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-stone-800 text-cream shadow-soft hover:bg-stone-700 hover:shadow-lg",
        secondary: "bg-latte-beige text-stone-800 hover:bg-coffee-hover",
        cloud:
        ...
        bold: "rounded-2xl border-2 border-espresso bg-dusty-blue text-cream shadow-hard hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-hard-lg active:translate-x-0 active:translate-y-0 active:shadow-none disabled:hover:translate-x-0 disabled:hover:translate-y-0",
        "bold-outline":
